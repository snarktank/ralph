#!/bin/bash
# Convert PRD markdown -> prd.json using Cursor CLI.
#
# Usage:
#   ./convert-to-prd-json.sh <path-to-prd-markdown> [--model MODEL] [--out OUT_JSON]
#
# Defaults:
# - MODEL: "auto"
# - OUT_JSON: ./prd.json (next to this script)
#
# Notes:
...
# Keep the prompt small: instruct Cursor to read/write files from disk.
PROMPT_TEXT="$(
