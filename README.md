...
After each iteration, Ralph updates the relevant `AGENTS.md` files with learnings. Claude Code automatically reads these files, so future iterations (and future human developers) benefit from discovered patterns, gotchas, and conventions.
